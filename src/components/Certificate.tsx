                    ...
                    >
                        ...
                        <div className="text-center">
                            <a
                                ...
                                className="inline-block px-4 py-2 border border-primaryColor text-primaryColor rounded-xl font-semibold text-sm sm:text-base transition-all duration-300 hover:bg-primaryColor hover:text-bgColor animate-pulse"
                            >
                                View Certificate
                            </a>
                        </div>
